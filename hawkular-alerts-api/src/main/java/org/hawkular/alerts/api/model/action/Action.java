 ...
 * @author Lucas Ponce
 */
@ApiModel(description = "An action is the abstract concept of a consequence of an event. + \n" +
        " + \n" +
        "An Action object represents a particular action linked with a specific event. + \n" +
        "Action objects are generated by the Alerts engine and processed by plugins. + \n" +
        "An Action object stores the eventId property and optionally may contain the full Event object. + \n" +
...
public class Action extends ActionDefinition implements Serializable {
    ...
    @ApiModelProperty(value = "Event id from where this action is generated.",
            position = 0)
    @JsonInclude
    private String eventId;

    @ApiModelProperty(value = "Time when this action was generated.",
            position = 1)
    @JsonInclude
    private long ctime;

    @ApiModelProperty(value = "Attached Event from where this action is generated.",
            position = 2)
    @Thin
    @JsonInclude(Include.NON_NULL)
    private Event event;

    @ApiModelProperty(value = "Result of action processing.",
            position = 3)
    @JsonInclude(Include.NON_NULL)
